  ...
  get template() {
    return `
      <section class="result">
        <div class="result__logo"><img src="img/melody-logo.png" alt="${data.header.logo}" width="186" height="83"></div>
        <h2 class="result__title">${data.result.win}</h2>
        ...
        <button class="result__replay" type="button">${data.buttons.replay}</button>
      </section>
    `;
  }
