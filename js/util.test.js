...
describe(`Stats`, () => {
  ...
  it(`should return Вы заняли 6 место из 6 игроков. Это лучше, чем у 0% игроков.`, () => {
    assert.strictEqual(showStats(setGameResults(1, 2, 100), statistics), `Вы заняли 6 место из 6 игроков. Это лучше, чем у 0% игроков.`);
  });
});
